...
import urllib3
import utils.google_auth.common as common
from utils.google_auth.common import (
    GCP_BASE_URL,
...
def retrieve_subject_token(
    credential_source_file: str, credential_source_format_type: str
):
    return _parse_token_data(
        _get_token_data(credential_source_file), credential_source_format_type
    )
