...
export const DESCRIPTION: string = "Simple app to convert all your files to text.";
...
export const FILE_INPUT_MIMETYPES: string = `${VALID_MIMETYPES.join(", ")} up to ${(MAX_FILE_SIZE / 1024 / 1024).toString()}MB`;