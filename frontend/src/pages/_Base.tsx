          ...
          <TabList className="-mb-px flex space-x-8">
            {TABS.map((tab) => (
              <Tab
                ...
                className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm outline-none data-[selected]:border-indigo-500 data-[selected]:text-indigo-600"
              >
